...
from dictdiffer.extractors import (DictExtractor,
                                   ListExtractor,
                                   SetExtractor,
...
class ExtractorTest(unittest.TestCase):
    def test_get_default_extractors(self):
        self.assertEqual({dict: DictExtractor,
                          list: ListExtractor,
                          set: SetExtractor,
                          'default': [DictExtractor,
                                      ListExtractor,
                                      SetExtractor]}, get_default_extractors())
