...
project = u'Dictdiffer'
copyright = u'2014, Fatih Erikli'
...
htmlhelp_basename = 'Dictdifferdoc'
...
latex_documents = [
  ('index', 'Dictdiffer.tex', u'Dictdiffer Documentation',
...
man_pages = [
    ('index', 'dictdiffer', u'Dictdiffer Documentation',
     [u'Fatih Erikli'], 1)
]
...
texinfo_documents = [
  ('index', 'Dictdiffer', u'Dictdiffer Documentation',
   u'Fatih Erikli', 'Dictdiffer', 'One line description of project.',
   'Miscellaneous'),
]
